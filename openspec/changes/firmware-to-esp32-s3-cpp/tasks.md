...
- [ ] 2.2 Implement 256-point FFT spectral analysis using `esp-dsp`.
...
- [ ] 3.2 Implement inference wrapper with sliding window for audio classification.
- [ ] 3.3 Port LoRa mesh communication logic to C++ and integrate with the alert system.
