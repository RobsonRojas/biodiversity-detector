...
- [x] 1.1 Create `src/esp32-s3-cpp` directory and initialize ESP-IDF project with CMake.
- [x] 1.2 Configure `sdkconfig` for ESP32-S3 with PSRAM and low-power optimzations.
- [x] 1.3 Add dependencies: `esp-dsp`, `esp_nn`, and Edge Impulse C++ SDK.

## 2. Audio Pipeline and DSP

- [x] 2.1 Implement I2S microphone driver with DMA and double-buffering.
- [x] 2.2 Implement multi-band FFT spectral analysis (100Hz to 20kHz) using `esp-dsp`.
- [x] 2.3 Create RMS threshold logic for the ULP/RTC wake-up phase.
- [x] 2.4 Implement frequency band detection for biological triggers (insects/amphibians).
